...
<body>
  ...
  <header>
    ...
    <div class="container">
        ...
        <a href="user.php" class="btn btn-primary">Kembali Ke Halaman Produk</a>
        ...
        <div class="card text-dark bg-light mb-3" style="max-width: 30rem;">
            ...
            <div class="card-body">
                <p class="card-text"><small class="text-muted">Nama Produk</small></p>
                <h5 class="card-title"><?= $pdk["nama_produk"]; ?></h5>
                <p class="card-text"><small class="text-muted">Merek</small></p>
                <h5 class="card-title"><?= $pdk["merek"]; ?></h5>
                <p class="card-text"><small class="text-muted">Spesifikasi</small></p>
                <p class="card-text"><?= $pdk["deskripsi"]; ?></p>
            </div>
        </div>
        </div>
