            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        <h3 class="mb-4 text-center">Registrasi Sekarang!</h3>
                        <form action="" class="signin-form" method="post">
                            ...
                            <div class="form-group">
                                <input id="password" type="password" class="form-control" placeholder="konfirmasi password" id="password2" name="password2" required>
                                <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                            </div>
                            <div class="form-group">
                                <button type="submit" class="form-control btn btn-primary submit px-3" id="register" name="register">Register</button>
                            </div>
                        </form>
                        <p class="w-100 text-center">&mdash; Sudah Punya Akun? &mdash;</p>
                        <div class="d-grid gap-2 col-6 mx-auto px-5 mb-3">
